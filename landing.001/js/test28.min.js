...
///////////////////////////////////////////////
    ...
    function BB_orderBillSender(){
        ...
        bb_formSubmission.addEventListener('click', (event) => {
            event.preventDefault();
            if(bb_actionFlag){
                console.log(333, bb_orderRecord.clientMessage, bb_contactMessageOriginal.textContent);
                ...
                console.log(444, bb_orderRecord.clientMessage, bb_contactMessageOriginal.textContent);
                bb_formSubmission.value = 'Thiếu thông tin';
                bb_formSubmission.style = 'background-color: #c36887; width: 220px;';
            }
        });
