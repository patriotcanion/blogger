...
(function (){
	const bb_contactFormDom = '<style>:root{--width:320px;--fontSize:16px}#bb-contact-form{display:none;position:absolute;z-index:100;left:0;top:0;justify-content:center;align-items:center;width:100%;height:100%;overflow:auto;background-color:#000;background-color:rgba(0,0,0,.4)}#ContactForm1{font-size:var(--fontSize);width:375px;padding-top:35px;padding-bottom:35px;margin:auto;background-color:#F7F6F4}#ContactForm1 .contact-form-widget{width:var(--width);margin:auto}#ContactForm1 .title{display:none;width:var(--width);margin:10px auto 35px auto;font-size:30px;font-weight:300}button,input[inputmode=numeric],input[type=text],textarea{font-family:inherit;font-size:var(--fontSize);border:none;outline:#E59802}button,*[data-control]{cursor:pointer}fieldset{border:none;padding:unset;margin-bottom:25px!important}label{display:inline-block;width:120px}#form-shopping-product>span{display:inline-block;width:100%;font-size:19px;font-weight:700;line-height:1.5;word-space:-2px}#form-shopping-product>small{font-weight:500;color:#0c80e3;margin-top:10px;display:inline-block;font-size:14px}input.bb-form-control{margin-left:10px;float:right;background-color:#ED6B5B}input.bb-form-control:hover{background-color:#575A6D}#form-shopping-quantity>span{display:inline-flex;border-radius:10px;overflow:hidden;border:1px solid #5e99f6}#form-shopping-quantity>span>button{outline:0;padding:10px 15px;width:40px}#form-shopping-quantity>span>input{text-align:center;width:45px;padding:10px;background-color:#f8f8f8}#form-shopping-quantity>span>button{color:#5e99f6;background-color:#fff}#form-shopping-quantity>span>button:hover{background-color:#e6e6e6}#form-shopping-lastCost{font-weight:700}#form-contact-email,#form-contact-message,#form-contact-name{display:none}#ContactForm1_contact-form-submit,#bb-form-contact-address>input,#bb-form-contact-message>textarea,#bb-form-contact-name>input,#bb-form-contact-phone>input{width:var(--width);border:1px solid #5e99f6;border-radius:4px;height:42px;padding:8px 15px;line-height:1.5;margin:auto;display:block;box-sizing:border-box}#bb-form-contact-message>textarea{height:100px;resize:none}#ContactForm1_contact-form-submit,.bb-form-control{color:#fff;font-weight:700;width:150px;height:48px;border-radius:30px;font-size:var(--fontSize);text-transform:uppercase;background-color:#3786C9;border:none;display:inline-block}#ContactForm1_contact-form-submit:hover,.bb-form-control:hover{background-color:#B4C640}#form-notification>p{width:var(--width);color:#F2CAC8;display:initial}</style><b:section id="bb-contact-form" class="main" showaddelement="yes"><b:widget id="ContactForm1" locked="false" title="Thông tin đơn hàng" type="ContactForm" version="2" visible="true"><b:includable id="main"><b:include name="widget-title"/><b:include name="content"/></b:includable><b:includable id="content"><div class="contact-form-widget"><div class="form"><form name="shopping-form"><fieldset id="form-shopping-product"><span></span></fieldset><fieldset id="form-shopping-price"><label>Đơn giá</label><span></span></fieldset><fieldset id="form-shopping-quantity"><label>Số lượng</label><span><button>-</button><input inputmode="numeric" value="1"/><button>+</button></span></fieldset><fieldset id="form-shopping-actualCost"><label>Tổng cộng</label><span/></fieldset><fieldset id="form-shopping-discount"><label>Giảm giá</label><span/></fieldset><fieldset id="form-shopping-shipCost"><label>Phí v.chuyển</label><span/></fieldset><fieldset id="form-shopping-lastCost"><label>Thanh toán</label><span/></fieldset></form><form name="contact-form"><fieldset id="bb-form-contact-name"><input name="name" placeholder="Tên khách hàng" type="text"/></fieldset><fieldset id="bb-form-contact-phone"><input inputmode="numeric" name="phone" placeholder="Số điện thoại, ví dụ: 0906600900"/></fieldset><fieldset id="bb-form-contact-address"><input name="address" placeholder="Địa chỉ nhận hàng, ví dụ: 20 Ngõ 898, Đường Láng, Đống Đa, Hà Nội" type="text"/></fieldset><fieldset id="bb-form-contact-message"><textarea name="message" placeholder="Ghi chú thêm"/></fieldset><fieldset id="form-contact-name"><input class="contact-form-name" expr:id="data:widget.instanceId + &quot;_contact-form-name&quot;" name="name" placeholder="Tên khách hàng" type="text"/></fieldset><fieldset id="form-contact-email"><input class="contact-form-email" expr:id="data:widget.instanceId + &quot;_contact-form-email&quot;" name="email" placeholder="Địa chỉ hòm thư" type="text"/></fieldset><fieldset id="form-contact-message"><textarea class="contact-form-email-message" expr:id="data:widget.instanceId + &quot;_contact-form-email-message&quot;" name="email-message"/></fieldset><input class="contact-form-button contact-form-button-submit" expr:id="data:widget.instanceId + &quot;_contact-form-submit&quot;" expr:value="data:contactFormSendMsg" type="button" value="Mua"/><input class="bb-form-control" data-control="close" type="button" value="Hủy"/><div clss="form-notification"><p class="contact-form-error-message" expr:id="data:widget.instanceId + &quot;_contact-form-error-message&quot;"/><p class="contact-form-success-message" expr:id="data:widget.instanceId + &quot;_contact-form-success-message&quot;"/></div></form></div></div></b:includable></b:widget></b:section>';
