...
console.log('11111111111111111', bb_orderRecord);
                    bb_modal.querySelector('textarea.contact-form-email-message').textContent =
    ...
    function BB_priceEstimator(_seekedQuantity){
        ...
        console.log('==========', bb_orderRecord);
        console.log('==========', _seekedQuantity, _lastTotalCost + _shipCost, _shipCost);
